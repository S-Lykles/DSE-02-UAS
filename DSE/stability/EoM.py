...
def EoM():
    ...
    My = M_ac_w + M_fus + M_ac_h - T_p*h_p +2*T_fr_left*l_fr -2*T_aft_left*l_aft +(L_w*h_ac +D_w*h_ac - L_h*h_h - D_h*l_h)*np.sin(alpha* deg2rad) +(L_w*l_ac +D_w*l_ac -L_h*l_h -D_h*h_h)*np.cos(alpha* deg2rad)
