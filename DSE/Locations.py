...
def locations():
    ...
    cg1 = cg.cg_per_mission(True, True, False, True, False)[1][0]
    cg2 = cg.cg_per_mission(True, False, True, False, True)[1][0]

    if cg1>=cg2:
        Xcg, Ycg, Zcg = cg.cg_per_mission(True, True, False, True, False)[1]
    else:
        Xcg, Ycg, Zcg = cg.cg_per_mission(True, False, True, False, True)[1]
    ...
    Xfr = cg.np.array(cg.components_dict['Liftprops1'])[1]
    Xaft = cg.np.array(cg.components_dict['Liftprops3'])[1]
    Xac = cg.np.array(cg.components_dict['WingL'])[1]
    Xac_v = cg.np.array(cg.components_dict['Vert Tail 1'])[1]
    Xh =  cg.np.array(cg.components_dict['Hor Tail'])[1]
    Zp = cg.np.array(cg.components_dict['Push-prop'])[3]
    Zac =  cg.np.array(cg.components_dict['WingL'])[3]
    Zh = cg.np.array(cg.components_dict['Hor Tail'])[3]
