...
if __name__ == '__main__':
    ...
    print(table_hybrid_propulsion_weights(P_cruise(b,S)/1000, P_max(DL, N)/1000, 3*60))

    opts = ['2-Stroke', '4-Stroke', 'Rotary', 'Turboshaft', 'hydrogen', 'battery']
    e_frac = [1,1,1,1,1/spec_tank_W,0]
    SFC = [SFC_2stroke, SFC_4stroke, SFC_rotarty, SFC_turboshaft, SFC_hydrogen, SFC_battery]
    m_f = []
