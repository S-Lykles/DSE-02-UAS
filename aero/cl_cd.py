...
def dragpolar_dual(b,S,h,v,c,Sf):                                 
    ...
    cd_dual = 2.5*cd0_wing + cl**2/(pi*A*e) + cd0_fus
    print(cd0_fus,cd0_wing)                         # (1/0.34) due to presence propellors -> Aerodynamic performance of aircraft wings with stationary vertical lift propellers
    return cl,cd_dual

print(cd0_fuselage(500,43,0.6,2))
