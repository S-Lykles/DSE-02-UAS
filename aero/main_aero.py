...
Lambda = 0.45
                                  ...
                                  # Cl_max
cl, cd_comp = dragpolar_comp(b,S,h,v,c,S_f)
cl, cd_dual = dragpolar_dual(b,S,h,v,c,S_f)     # (b,S,h,v,c,S_fuselage)
cl, cd_tilt_wing = dragpolar_tilt_wing(b-1,S,h,v,c,S_f,d_eng,N_eng,Lambda)
print("cd0 dual",cd_dual[0])
print("cd0 comp",cd_comp[0])
print("cd0 tilt",cd_tilt_wing[0])
plots()
